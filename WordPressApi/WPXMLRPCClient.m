...
//    }
	[self setDefaultHeader:@"User-Agent"  value:[NSString stringWithFormat:@"cheftap-ios/%@",  [[[NSBundle mainBundle] infoDictionary] objectForKey:(NSString *)kCFBundleVersionKey]]];
